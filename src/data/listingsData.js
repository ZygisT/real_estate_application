const listingsData = [
  ...
  },
  {
    ...
    state: "NJ",
    homeType: "Condo",
    description: 'Beautiful spacious house with 4 bedrooms and 2 bathrooms in a quite neighborhood, large kitchen with a dining room, huge backyard.',
    bedrooms: 4,
    bathrooms: 2,
    price: 140500,
    floorSpace: 205,
  ...
  },
  {
    ...
    state: "CA",
    homeType: "Condo",
    description: 'Beautiful 5 bedroom condo in excellent condition. Home has new windows, wall to wall carpeting, and eat-in kitchen.  Great home for the first time homebuyer or an investor.',
    bedrooms: 5,
    bathrooms: 4,
    price: 316000,
    floorSpace: 245,
